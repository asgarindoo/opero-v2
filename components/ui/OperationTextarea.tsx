...
export default function OperationTextarea({ label, icon, maxLength, required, value, ...props }: Props) {
  ...
  return (
    <div>
      ...
      <textarea
        ...
        value={value}
        maxLength={maxLength}
        className="w-full resize-none font-body-md text-[13px] rounded-[6px] px-3 py-2.5 outline-none transition-all"
