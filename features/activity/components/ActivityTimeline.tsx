             ...
             {group.activities.map(activity => {
                ...
                return (
                  <div 
                    ...
                    className="group flex items-center gap-4 px-8 py-2.5 hover:bg-black/1 transition-all cursor-pointer border-l-2 border-l-transparent hover:border-l-primary/40"
                  >
                    ...
                    <div className="flex-1 flex items-center gap-2 overflow-hidden">
                       <span className="font-body text-[12.5px] text-on-surface-variant opacity-80 whitespace-nowrap overflow-hidden text-ellipsis">
                          <span className="font-display font-bold text-on-surface opacity-90">{getUserDisplayName(activity.user)}</span>
