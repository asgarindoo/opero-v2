...
export default function DocumentList({ onSelectFile }: Props) {
  ...
  const getFileIcon = (type?: FileType | string, extension?: string) => {
    switch (type) {
                ...
                <TableRow key={i} className="h-14 hover:bg-black/[0.015] transition-colors">
                  ...
                  <TableCell className="max-w-[0px]">
                    <div className="flex items-center gap-3 ml-3">
                      <div className="w-7 h-7 rounded-[6px] bg-black/[0.03] animate-pulse shrink-0" />
                  ...
                  <TableCell className="hidden lg:table-cell max-w-[0px]">
                    <div className="flex items-center gap-1.5 w-full">
                      <div className="w-5 h-5 rounded-full bg-black/[0.04] animate-pulse shrink-0" />
                      <div className="h-3 w-16 bg-black/[0.04] rounded animate-pulse" />
                    </div>
                  </TableCell>
